...
def generate_launch_description():
    ...
    urdf_path  =  os.path.join(pkg_project_description, 'urdf', 'robot_lab6.urdf.xacro')
    ...
    gz_sim = IncludeLaunchDescription(
        ...
        launch_arguments={'gz_args': "-r /home/mary/ws55/src/robot_bringup/worlds/boxes.sdf"}.items(),
    )
    ...
    rviz = Node(
       package='rviz2',
       executable='rviz2',
       arguments=['-d', os.path.join(pkg_project_bringup, 'config', 'imu.rviz')],
